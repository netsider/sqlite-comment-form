...
if (isset($_POST['submit'])){
	...
	if (strlen($_POST['TEXT']) >= 1){
		...
		if ($duplicates == 0){
				...
				$db->exec("INSERT INTO $TABLE (TextData, Title, Date, SessID, Time) VALUES ('$TEXT', '$TITLE', '$DATE', '$sid', Time());");
		}else{
			echo "<br/><font color=red>Identical Data Already Exists!</font><br/>";
		}
...
echo '<br/>';
   ...
   $t_result = $db->query("SELECT TIME FROM $TABLE WHERE SessID = '$sid' ORDER BY Time DESC"); // Lists all the times for a certain SID
