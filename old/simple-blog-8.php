...
$TITLE = "SSS";
  try
  {
    ...
    $db->exec("CREATE TABLE $TABLE (Id INTEGER PRIMARY KEY, Title TEXT, TextData TEXT, Date DATE)");    
	//insert some data...
    //$db->exec("INSERT INTO $TABLE (Breed, Name, Age) VALUES ('$TEXT2', '$TITLE', 2);".
      //         "INSERT INTO Dogs (Breed, Name, Age) VALUES ('Husky', 'Glacier', 7); " .
        //       "INSERT INTO Dogs (Breed, Name, Age) VALUES ('Golden-Doodle', 'Ellie', 4);");
   //$db->exec("INSERT INTO $TABLE (Breed, Name, Age) VALUES ('$TEXT2', '$TITLE', 2);");
   $db->exec("INSERT INTO $TABLE (Title, TextData, Date) VALUES ('$TEXT2', '$TITLE', '11-11-2014');");
  }
