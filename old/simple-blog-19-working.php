...
if (isset($_POST['submit'])){
	...
	if (strlen($_POST['TEXT']) >= 1){
		$db->exec("CREATE TABLE $TABLE (Id INTEGER PRIMARY KEY, Title VARCHAR, TextData TEXT, Date VARCHAR, Session_ID VARCHAR)");    
		$db->exec("INSERT INTO $TABLE (Title, TextData, Date) VALUES ('$TEXT', '$TITLE', '$DATE');");
		$db->exec("INSERT INTO $TABLE (Session_ID) VALUES ('$sid');");
	}
}else{
	$TEXT = "";
	$TITLE = "";
